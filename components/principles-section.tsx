  ...
  const principles = [
    {
      ...
      titleParts: [
        ...
        { text: "-LAG SYNCHRONIZATION", highlight: false },
      ],
      description: "Sub-150ms latency across all devices through HiveMQ pub/sub architecture ensuring real-time updates.",
      align: "left",
    },
    {
      number: "02",
      titleParts: [
        { text: "PAPERLESS ", highlight: false },
        { text: "QR TOKENS", highlight: true },
      ],
      description: "Dynamic Matrix QR codes generated on ESP32 OLED screens eliminate costly thermal printers.",
      align: "right",
    },
    {
      number: "03",
      titleParts: [
        { text: "ADAPTIVE ", highlight: false },
        { text: "INTERFACES", highlight: true },
      ],
      description: "Fully responsive design from ultra-wide monitors to handheld devices with Tailwind CSS.",
      align: "left",
    },
    {
      number: "04",
      titleParts: [
        { text: "LIVE ", highlight: false },
        { text: "ANALYTICS", highlight: true },
      ],
      description: "Real-time dashboards with wait times, traffic flow, and operator efficiency powered by Supabase.",
      align: "right",
    },
  ]
  ...
  return (
    <section ref={sectionRef} id="principles" className="relative py-32 pl-6 md:pl-28 pr-6 md:pr-12">
      ...
      <div ref={headerRef} className="mb-24">
        ...
        <h2 className="mt-4 font-[var(--font-bebas)] text-5xl md:text-7xl tracking-tight">CORE VALUES</h2>
      </div>
