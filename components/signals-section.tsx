...
const signals = [
  {
    date: "2026.03.25",
    title: "Next.js 15 Integration",
    note: "Full App Router support with Server Components and real-time data revalidation.",
  },
  {
    date: "2026.03.20",
    title: "Supabase PostgreSQL",
    note: "Complete backend with Row-Level Security and real-time subscriptions.",
  },
  {
    date: "2026.03.15",
    title: "HiveMQ MQTT Broker",
    note: "Production-ready WebSocket and TCP connections for zero-lag synchronization.",
  },
  {
    date: "2026.03.10",
    title: "React Native Dashboard",
    note: "Cross-platform mobile app with Expo and native performance optimization.",
  },
  {
    date: "2026.03.05",
    title: "Hardware Firmware",
    note: "ESP32 firmware with I2C OLED display driver and secure MQTT communication.",
  },
]
  ...
  return (
    <section id="signals" ref={sectionRef} className="relative py-32 pl-6 md:pl-28">
      ...
      <div ref={headerRef} className="mb-16 pr-6 md:pr-12">
        <span className="font-mono text-[10px] uppercase tracking-[0.3em] text-accent">01 / Technology</span>
